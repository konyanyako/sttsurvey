  ...
  return (
    <div className={styles.question}>
      ...
      <div className={styles.inputArea}>
        {type === "text" && <input name={id} defaultValue={value} required={required} />}
        {type === "email" && <input type="email" name={id} defaultValue={value} required={required} />}
        {type === "textarea" && <textarea name={id} defaultValue={value} required={required}></textarea>}
